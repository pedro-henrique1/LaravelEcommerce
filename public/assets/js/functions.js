    ...
    var MERCADO_JS = {
        ...
        mercado_chosen: function () {
            if ($(".wrap-search-form .wrap-list-cate").length > 0) {
                $(".wrap-search-form .wrap-list-cate").on(
                    "click",
                    ".link-control",
                    function (event) {
                ...
                $(".wrap-search-form .wrap-list-cate .list-cate").on(
                    "click",
                    "li",
                    function (event) {
                        var _this = $(this),
        ...
        mercado_toggle_slide_menu: function () {
            ...
            if ($(".widget .list-limited .default-hiden").length > 0) {
                $(document).on(
                    "click",
                    ".widget .list-limited .btn-control",
                    function (e) {
                        e.preventDefault();
                        var _this = $(this),
        ...
        mercado_clone_all_zan_menus: function () {
            ...
            $(".clone-main-menu").each(function () {
                ...
                if (!$("#" + this_menu_clone_id).length) {
                    ...
                    thisClone.find("[id]").each(function () {
                        ...
                        thisClone
                            ...
                            .attr(
                                "href",
                                "#" +
                                MERCADO_JS.mercado_add_string_prefix(
                                    $(this).attr("id"),
                                    "mercado-clone-"
                                )
                            );
                    ...
                    thisClone
                        .find(".mercado-menu")
                        .addClass("mercado-menu-clone");
                    var thisMenuId = "mercado-panel-" + $this.attr("id"),
                        thisMenuname = $this.data("menuname");
                    // Create main panel if not exists
                    if (
                        !$(
                            ".mercado-clone-wrap .mercado-panels #mercado-main-panel"
                        ).length
                    ) {
                    ...
                    $(
                        ...
                        '<li class="menu-item"><a data-target="#' +
                        thisMenuId +
                        '" class="mercado-next-panel" href="#' +
                        thisMenuId +
                        '"></a><a title="' +
                        thisMenuname +
                        '" class="mercado-item-title" href="#">' +
                        thisMenuname +
                        "</a></li>"
                    );
                    ...
                    if (
                        !$(
                            ".mercado-clone-wrap .mercado-panels #mercado-panel-" +
                            this_menu_id
                        ).length
                    ) {
                        $(".mercado-clone-wrap .mercado-panels").append(
                            '<div id="mercado-panel-' +
                            this_menu_id +
                            '" class="mercado-panel mercado-hidden"><ul class="depth-01"></ul></div>'
                        );
                    }
                    var thisMainPanel = $(
                        ".mercado-clone-wrap .mercado-panels #mercado-panel-" +
                    ...
                    MERCADO_JS.mercado_insert_children_panels_html_by_elem(
                        thisMainPanel,
                        i
                    );
                }
            ...
            if ($elem.find(".menu-item-has-children").length) {
                $elem.find(".menu-item-has-children").each(function () {
                    ...
                    thisChildItem.prepend(
                        '<a class="mercado-next-panel" href="#' +
                        next_nav_target +
                        '" data-target="#' +
                        next_nav_target +
                        '"></a>'
                    ...
                    // Get sub menu html
                    var submenu_html = $("<div>")
                        .append(
                            thisChildItem
                                .find("> .submenu,> .wrap-megamenu")
                                .clone()
                        )
                        .html();
                    ...
                    $(".mercado-clone-wrap .mercado-panels").append(
                        '<div id="' +
                        next_nav_target +
                        '" class="mercado-panel mercado-sub-panel mercado-hidden">' +
                        submenu_html +
                        "</div>"
                    );
                });
        ...
        mercado_control_panel: function () {
            $(document).on("click", ".mercado-next-panel", function (e) {
                ...
                if ($(target_id).length) {
                    ...
                    $(target_id)
                        .addClass("mercado-panel-opened")
                        .removeClass("mercado-hidden")
                    ...
                    $(".mercado-panels-actions-wrap")
                        .find(".mercado-current-panel-title")
                        .remove();
                    $(".mercado-panels-actions-wrap").prepend(
                        '<span class="mercado-current-panel-title">' +
                        item_title +
                        "</span>"
                    );
            ...
            $(document).on("click", ".mercado-prev-panel", function (e) {
                ...
                $(cur_panel_id)
                    .removeClass("mercado-panel-opened")
                    .addClass("mercado-hidden");
                $(target_id)
                    .addClass("mercado-panel-opened")
                    .removeClass("mercado-sub-opened");

                // Set new back button
                var new_parent_panel_id =
                ...
                if (
                    ...
                    var item_title = "";
                    item_title = $("#" + new_parent_panel_id)
                        .find(
                            '.mercado-next-panel[data-target="' +
                            target_id +
                            '"]'
                        )
                        .siblings(".mercado-item-title")
        ...
        mercado_tabs: function () {
            if ($(".tab-control:not(.normal)").length > 0) {
                if ($(".tab-contents").length) {
                    setTimeout(function () {
                        $(".tab-contents:not(.tab-not-equal)").each(
                            function () {
                                var $this = $(this);
                                if ($this.find(".tab-content-item").length) {
                                    ...
                                    $this
                                        ...
                                        .each(function () {
                                            ...
                                            if (
                                                parseInt(elem_height, 10) <
                                                parseInt(this_elem_h, 10)
                                            ) {
                                                elem_height = parseInt(
                                                    this_elem_h,
                                                    10
                                                );
                                            }
                ...
                $(document).on(
                    ...
                    function (ev) {
                        ...
                        if (!$(this).hasClass("active")) {
                            ...
                            _this
                                .closest(".wrap-product-tab")
                                .find(".tab-contents .active")
                                .removeClass("active");
                            _tab_active.addClass("active");
                            _tab_active
                                .find(".wrap-products .owl-item")
                                .each(function (index) {
                                    var owl_item = $(this),
                ...
                $(".quantity-input").on("click", ".btn", function (event) {
                    ...
                    var _this = $(this),
                        ...
                        _current_value = _this
                            .siblings("input[name=product-quatity]")
                            .val(),
                        _max_value = _this
                            .siblings("input[name=product-quatity]")
                            .attr("data-max");
        ...
        mercado_sticky_menu: function () {
            ...
            if (
                parseInt(_device_size, 10) > 1024 &&
                $(".header-sticky").length > 0
            ) {
                var header_height = $(".header").innerHeight(),
                    ...
                    vertical_menu = $(
                        ".primary-nav-section.vertical-menu-toggle"
                    );
                if (vertical_menu.length > 0) {
                    vertical_menu_title_height = vertical_menu.innerHeight();
                    vertical_menu_height = vertical_menu
                        .find(".nav.primary")
                        .innerHeight();
                    header_sticky.on("sticky-start", function () {
                        vertical_menu
                            .find(".wrap-toggle-menu")
                            .addClass("close-menu");
                    });
                }
                if (parseInt(vertical_menu_height, 10) > 0) {
                    _topSpacing =
                        ...
                        (parseInt(header_height, 10) +
                            parseInt(vertical_menu_height, 10) -
                            parseInt(vertical_menu_title_height, 10));
                }
            ...
            if ($(".mercado-google-maps").length == 1) {
                $(".mercado-google-maps").each(function () {
                    var $this = $(this),
                        ...
                        $modify_coloring =
                            $this.attr("data-modify-coloring") === "true"
                                ? true
                                : false,
                        ...
                        if ($map_style == "1") {
                            if (infoWindowContent[i][0].length > 1) {
                                infoWindow.setContent(
                                    ...
                                    $title_maps +
                                    "</h4>" +
                                    '<div class="map-field"><i class="fa fa-map-marker"></i><span>&nbsp;' +
                                    $address +
                                    "</span></div>" +
                                    '<div class="map-field"><i class="fa fa-phone"></i><span>&nbsp;' +
                                    $phone +
                                    "</span></div>" +
                                    '<div class="map-field"><i class="fa fa-envelope"></i><span><a href="mailto:' +
                                    $email +
                                    '">&nbsp;' +
                                    $email +
                                    "</a></span></div> " +
                        ...
                        if ($map_style == "2") {
                            google.maps.event.addListener(
                                ...
                                (function (marker, i) {
                                    return function () {
                                        if (
                                            infoWindowContent[i][0].length > 1
                                        ) {
                                            infoWindow.setContent(
                                                '<div style="background-color:#fff; padding: 30px 30px 10px 25px; width:290px;line-height: 22px" class="mercado-map-info">' +
                                                '<h4 class="map-title">' +

            ...
            <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true"
                ...
                <div class="item-slide">
                    ...
                    <div class="slide-info slide-1">
                        <h2 class="f-title"><b
                                style="color: #{{ $slide->colortitle }}!important">{{ $slide->title }}</b></h2>
                        <span class="subtitle"
                            style="color: #{{ $slide->colorsubtitle }}!important">{{ $slide->subtitle }}</span>

                        <p class="sale-info" style="color: #{{ $slide->colorsaleinfo }}!important">Only price:
                            <span class="price"
                                style="color: #{{ $slide->colorsale }}!important">{{ $slide->price }}</span></p>

            ...
            <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true"
                ...
                <div class="item-slide">
                    ...
                    <div class="slide-info slide-1">
                        <h2 class="f-title"><b style="color: #{{ $slide->colortitle }}!important">{{ $slide->title }}</b></h2>
                        <span class="subtitle" style="color: #{{ $slide->colorsubtitle }}!important">{{ $slide->subtitle }}</span>

                        <p class="sale-info" style="color: #{{ $slide->colorsaleinfo }}!important">Only price: 
                            <span class="price" style="color: #{{ $slide->colorsale }}!important">{{ $slide->price }}</span></p>
        ...
        <div class="wrap-show-advance-info-box style-1 has-countdown">
            ...
            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5"
                ...
                <div class="product product-style-2 equal-elem ">
                    <div class="product-thumnail">
                        <a href="detail.html" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                            <figure><img src="{{asset('assets/images/products/digital_04.jpg')}}" width="800"
                                    height="800" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
                        </a>
                        <div class="group-flash">
                            <span class="flash-item sale-label">sale</span>
                        ...
                        <div class="tab-content-item active" id="digital_1a">
                            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                ...
                                <div class="product product-style-2 equal-elem">
                                    ...
                                    <div class="product-info">
                                        <a href="{{route('product.details', ['slug'=>$lproduct])}}"

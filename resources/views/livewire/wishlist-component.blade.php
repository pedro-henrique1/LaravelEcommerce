<main id="main" class="main-site left-sidebar">
    <div class="container">
        ...
        <div class="row">
                ...
                <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                    <div class="product product-style-3 equal-elem ">
                        ...
                        <div class="product-info">
                            ...
                            <a href="{{route('product.details',['slug'=>$item->model->slug])}}"
                                title="{{$item->model->name}}" class="btn add-to-cart" wire:click.prevent="store({{$item->model->id}}, '{{$item->model->name}}',
                                {{$item->model->regular_price}})">Add
                                To Cart</a>
            ...
            @else
            <p class='h2 text-center'>No item in wishlist</p>
            @endif
        </div>
    </div>
</main>
